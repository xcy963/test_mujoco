...
int main(int argc, char** argv) {
    ...
    auto node = std::make_shared<rclcpp::Node>("test_realsense_node");
    ...
    const char* filename = "/home/hitcrt/enginner_26/test_mujoco_ros/src"
              "/test_mujoco/modules/trs_so_arm100/scene.xml";
    ...
    RCLCPP_INFO(node->get_logger(),"mujoco已经退出了,退出ros");
    rclcpp::shutdown();
    executor.spin();
